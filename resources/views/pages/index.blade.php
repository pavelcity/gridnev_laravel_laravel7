...
@section('content')
    ...
    <div class="uk-container" style="margin-bottom: 0px;">
        @if(session('oksubs'))
    ...
    <div class="utp">
        <div class="top_side">
            <a href="/"><img class="topLogo" src="/img/logo_dash2.jpg" alt=""></a>
            <ul class="topMenu">
        ...
        <div class="bottom_side">
            <img class="koloski" src="/img/kol_l.svg" alt="">
            <img src="/img/title.svg" alt="">
            <img class="koloski" src="/img/kol_r.svg" alt="">
        </div>
