            ...
            <fieldset class="uk-fieldset">
                ...
                <div class="uk-margin">
                    ...
                    <div class="uk-form-controls">
                        <input class="uk-input" id="one_title" name="one_title" type="text" placeholder="Заголовок" value="{{ $contact->one_title }}">
                    </div>
                </div>
                ...
                <div class="uk-margin">
                    ...
                    <div class="uk-form-controls">
                        <input class="uk-input" id="one_index" name="one_index" type="text" placeholder="индекс" value="{{ $contact->one_index }}">
                    </div>
                </div>
                ...
                <div class="uk-margin">
                    ...
                    <div class="uk-form-controls">
                        <input class="uk-input" id="one_street" name="one_street" type="text" placeholder="улица" value="{{ $contact->one_street }}">
                    </div>
                </div>
                ...
                <div class="uk-margin">
                    ...
                    <div class="uk-form-controls">
                        <input class="uk-input" id="one_phone" name="one_phone" type="text" placeholder="номер телефона" value="{{ $contact->one_phone }} ">
                    </div>
                </div>
                ...
                <div class="uk-margin">
                    ...
                    <div class="uk-form-controls">
                        <input class="uk-input" id="one_email" name="one_email" type="text" placeholder="e-mail" value="{{ $contact->one_email }}">
                    </div>
                </div>
                ...
                <div class="uk-margin">
                    ...
                    <div class="uk-form-controls">
                        <input class="uk-input" id="two_title" name="two_title" type="text" placeholder="Заголовок" value="{{ $contact->two_title }}">
                    </div>
                </div>
                ...
                <div class="uk-margin">
                    ...
                    <div class="uk-form-controls">
                        <input class="uk-input" id="two_prodazi_1_phone" name="two_prodazi_1_phone" type="text" placeholder="номер телефона" value="{{ $contact->two_prodazi_1_phone }}">
                    </div>
                </div>
                ...
                <div class="uk-margin">
                    ...
                    <div class="uk-form-controls">
                        <input class="uk-input" id="two_prodazi_2_phone" name="two_prodazi_2_phone" type="text" placeholder="номер телефона" value="{{ $contact->two_prodazi_2_phone }}">
                    </div>
                </div>
                ...
                <div class="uk-margin">
                    ...
                    <div class="uk-form-controls">
                        <input class="uk-input" id="two_snabzenie_1_phone" name="two_snabzenie_1_phone" type="text" placeholder="номер телефона" value="{{ $contact->two_snabzenie_1_phone }}">
                    </div>
                </div>
                ...
                <div class="uk-margin">
                    ...
                    <div class="uk-form-controls">
                        <input class="uk-input" id="two_technologi_1_phone" name="two_technologi_1_phone" type="text" placeholder="номер телефона" value="{{ $contact->two_technologi_1_phone }}">
                    </div>
                </div>
                ...
                <div class="uk-margin">
                    ...
                    <div class="uk-form-controls">
                        <input class="uk-input" id="tri_title" name="tri_title" type="text" placeholder="Заголовок" value="{{ $contact->tri_title }}">
                    </div>
                </div>
                ...
                <div class="uk-margin">
                    ...
                    <div class="uk-form-controls">
                        <input class="uk-input" id="tri_phone" name="tri_phone" type="text" placeholder="номер телефона" value="{{ $contact->tri_phone }}">
                    </div>
                </div>
                ...
                <div class="uk-margin">
                    ...
                    <div class="uk-form-controls">
                        <input class="uk-input" id="four_title" name="four_title" type="text" placeholder="Заголовок" value="{{ $contact->four_title }}">
                    </div>
                </div>
                ...
                <div class="uk-margin">
                    ...
                    <div class="uk-form-controls">
                        <input class="uk-input" id="four_phone" name="four_phone" type="text" placeholder="e-mail" value="{{ $contact->four_phone }}">
                    </div>
                </div>
