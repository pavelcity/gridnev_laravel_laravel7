...
@section('content')
    ...
    <div class="" uk-grid>
        ...
        <div class="uk-width-expand@m uk-padding">
            ...
            <div class="uk-h3">Создать магазин</div>
            ...
            <fieldset class="uk-fieldset">
                ...
                <div class="uk-margin-top">
                    ...
                    <input class="uk-input" id="title" name="name" type="text" placeholder="" value="{{ old('name') }}">
                </div>

                <div class="uk-margin">
                    <label class="uk-form-label" for="timejob">Время работы</label>
                    <input class="uk-input" id="timejob" name="time_job" type="text" placeholder="" value="{{ old('time_job') }}">
                </div>

                <div class="uk-margin">
                    <label class="uk-form-label" for="phone_shop">Телефон пекарни</label>
                    <input class="uk-input" id="phone_shop" name="phone_shop" type="text" placeholder="" value="{{ old('phone_shop') }}">
                </div>
